...
/* 
 * NXP 9DOF Calibration
 * Teensy 3.5
 *
 * 3/20/2019
 * 
 * Use this code to calibrate the magnetometer
 * 
 * Make sure to download motionCal app at https://www.pjrc.com/store/prop_shield.html
 *
 * 1. Run Script and double check that serial monitor is working 
 * 2. Close Serial monitor 
 * 3. upload code again
 * 3. Open MotionCal app and connect to proper port 
 * 4. Rotate IMU around to get calibration values
 * 5. Put calibration values into main script
 * 6. Calibration should take about 2 minutes if the data values are slow start or not working, start from step three 
 * 
 * For more information: https://learn.adafruit.com/nxp-precision-9dof-breakout/overview
*/
